...
exports.login = asyncHandler(async (req, res, next) => {
  ...
  // Check for user
  const user = await User.findOne({ email }).select('+password') // +password because select: false in the model
...
exports.resetPassword = asyncHandler(async (req, res, next) => {
  ...
  // Set new password
  user.password = req.body.password // encrypted with our middleware
